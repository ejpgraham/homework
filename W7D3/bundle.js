...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(72);
...
var _giphy_actions2 = _interopRequireDefault(_giphy_actions);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.fetchSearchGiphys = _giphy_actions2.default;
...
var GiphysSearch = function (_React$Component) {
  ...
  function GiphysSearch() {
    ...
    _this.state = { searchTerm: "french bulldog" };
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function componentDidMount() {
      this.props.fetchSearchGiphys('french+bulldog');
    }
  }, {
    key: 'handleChange',
...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=" + searchTerm + "&api_key=dc6zaTOxFJmzC&limit=40"
  });
};
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(149);
