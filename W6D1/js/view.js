...
View.prototype.exercise4 = function () {
  ...
  $(".square:nth-child(2n)").text("Edward")
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $('.square').on("click", e => {
    const $sqre = $(e.currentTarget);
    alert($sqre.attr("data-pos"))
  })
};
...
View.prototype.exercise6 = function () {
  ...
  $('.square').each( (idx, el) => {
    var $sqre = $(el);
    $sqre.css("background-color", _randomColorString());
  })
};
...
View.prototype.exercise7 = function(){
  ...
  $('#easel').on("mouseenter", ".square", e => {
    const $sqre = $(e.currentTarget);
    console.log($sqre.css("background-color"));
  });
};
